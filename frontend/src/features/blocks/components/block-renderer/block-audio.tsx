...
interface BlockAudioProps extends BlockTypeBaseProps {}

export function BlockAudio({ block, isEditMode = false }: BlockAudioProps) {
  const dispatch = useAppDispatch()

  if (block.type !== BlockTypes.Audio) return null
